...
public class TerrainShader extends ShaderProgram{
	...
	private int location_imageCount;
	...
	protected void getAllUniformLocations() {
		...
		location_imageCount = super.getUniformLocation("imageCount");
	...
	public void loadImageCount(float imageCount){
		super.loadFloat(location_imageCount, imageCount);
	}
