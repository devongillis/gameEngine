...
public class ComplexParticleSystem {
	...
	private void emitParticle(Vector3f center) {
		...
		if(!ParticleMaster.reAssignParticle(texture, new Vector3f(center), velocity, gravityComplient, lifeLength, rotation, scale)){
			new Particle(texture, new Vector3f(center), velocity, gravityComplient, lifeLength, rotation, scale);
